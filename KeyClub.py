...
def render_about_page():
    ...
    st.subheader("I pledge, on my honor,")
    st.subheader("to uphold the Objects of Key Club International;")
    st.subheader("to build my home, school and community;")
    st.subheader("to serve my nation and world;")
    st.subheader("and combat all forces which tend to undermine these institutions.")
...
def render_contact_page():
    ...
    with st.container():
        ...
        if col5.button("Contact the Freshman Rep", key="Freshman Rep"):
            st.markdown(f"Click [here](mailto:{prefecody_email}) to send an email to your Freshman Rep.", unsafe_allow_html=True)
